...
function TrimPage() {
  ...
  const handleTimelineDown = (e: React.MouseEvent | React.TouchEvent, edge: 'start' | 'end' | 'range') => {
    if (!videoInfo) return;
    e.preventDefault();
          ...
          <div className="controls-section">
            ...
            <div className="timeline-container" onClick={handleTimelineClick}>
               ...
               <div
                 ...
                 onMouseDown={(e) => handleTimelineDown(e, 'range')}
                 onTouchStart={(e) => handleTimelineDown(e, 'range')}
                 style={{
                   left: `${(startTime / videoInfo.duration) * 100}%`,
